              ...
              <table class="table table-hover table-bordered " id="sampleTable">
                ...
                @foreach($Sections as $Section)
                 <tr>
                    ...
                    <td>{{$Section->name}}</td>
                    @can('role-edit')
                    <td> <a  href="" data-toggle="modal" data-target="#edit{{$Section->id}}" class="btn btn-warning mr-3 ml-2">
...
<div class="modal hide fade in " data-keyboard="false" data-backdrop="static" id="edit{{$Section->id}}">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    {!! Form::open(['action' => ['App\Http\Controllers\admin\medicinesController@update',$medicines->id], 'method' => 'POST','enctype'=>'multipart/form-data']) !!}
            ...
            {{Form::hidden('_method','PUT')}}
              ...
              @can('role-delete')
              <td>
                    {!!Form::open(['action' => ['App\Http\Controllers\admin\medicinesController@destroy',$medicine->id],'method'=>'POST', 'class'=>'pull-right','onsubmit' => 'return ConfirmDelete()'])!!}
