...
switch($name)
{
    ...
    case "list products": $name = "عرض المنتجات";break;
    case "add product": $name = "انشاء منتج";break;
    case "edit product": $name = "تعديل المنتج";break;
    case "delete product": $name = "حذف منتج";break;
    case "list orders": $name = "عرض  الطلبات"; break;
    case "add order": $name = "انشاء طلب جديد";break;
    case "edit order": $name = "تعديل  الطلب  ";break;
    case "delete order": $name = "حذف الطلب";break;
    case "list categories": $name = "عرض الاصناف"; break;
    case "add category": $name = "انشاء صنف جديد";break;
    case "edit category": $name = "تعديل صنف  ";break;
    case "delete category": $name = "حذف صنف";break;
