    ...
    ], function ()
{
    ...
    Route::get('/reservation/setStatus',[App\Http\Controllers\ReservationController::class,'setStatus'])->name('Reservation.setStatus');
    Route::get('/reservation/setUser',[App\Http\Controllers\ReservationController::class,'setUser']);
