...
Route::get('/token','App\Http\Controllers\Api\ReservationController@token');
Route::get('/method','App\Http\Controllers\Api\ReservationController@method');
Route::resource('/reservation',App\Http\Controllers\Api\ReservationController::class);
